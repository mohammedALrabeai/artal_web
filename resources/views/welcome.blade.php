                            ...
                            <div class="fixed inset-0 z-50 flex items-center justify-center bg-gray-900 bg-opacity-75">
                                <div class="p-6 bg-white rounded shadow-lg w-96">
                                    ...
                                    <div class="flex justify-end mt-4">
                                        <button wire:click="$set('showConfirmationForm', false)" class="px-4 py-2 mr-2 text-gray-700 bg-gray-300 rounded">
                                            Cancel
                                        </button>
                                        <button wire:click="confirmResignation" class="px-4 py-2 text-white bg-blue-500 rounded">
                                            Proceed
                                        </button>
                                    </div>
                                </div>
