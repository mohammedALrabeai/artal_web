...
Route::get('/attendance7', [AttendanceController::class, 'getAttendanceStatusV7']);  // مع التحضير اليدوي
Route::get('/attendance8', [AttendanceController::class, 'getAttendanceStatusV8']);
...
Route::get('/active-shifts-summary-v3', [\App\Http\Controllers\Api\ActiveShiftController::class, 'indexV3']);
...
Route::get('/employee-statuses-with-overdue-renewal', [EmployeeStatusController::class, 'getTodayAttendedWithOverdueRenewal']);
// });
...
Route::post('/face/reset-enrollment', [FaceAuthController::class, 'resetEnrollment']); 
